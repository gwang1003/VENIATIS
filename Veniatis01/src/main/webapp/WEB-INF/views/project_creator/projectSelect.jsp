					...
					<div class="apply_cont">
						...
						<div class="select_type">
							<div class="apply_support">
								...
								<a class="btn_apply" onclick="javascript:location.href='projectStart.do';" style="cursor: pointer;">프로젝트 개설 신청하기</a>
							...
							<div class="apply_stock">
								...
								<a class="btn_apply" onclick="fnAuthCheck();" style="cursor: pointer;">프로젝트 개설 신청하기</a>
