   ...
   <br>
      ...
      <div id="cMain">
         <header class="head_comm">
            <h1 class="tit_comm">창업 프로젝트 수정하기</h1>
         </header>
      ...
      <!-- 신청서 -->
         ...
         <div class="sheet_info">
            <div class="form_area">
               <form action="startUpprojectUpdate.do" name="addForm" id="frm" method="post" enctype="multipart/form-data" onsubmit="return fn_validateCheck()">
