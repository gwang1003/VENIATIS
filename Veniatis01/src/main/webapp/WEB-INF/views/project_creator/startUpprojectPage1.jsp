...
<body>
	...
	<br>
		...
		<form action="startUpInsert.do" name="addForm" method="post" enctype="multipart/form-data" onsubmit="return checkOption()">
			...
			<!-- 개설자 정보 -->
				...
				<div class="form_area">
					...
					<fieldset class="fld_comm">
						<ul>
							<li class="box_info">
								<p class="tit_name">창업희망 회사명<span class="txt_warning">*</span></p>
								<p class="txt_input">

									<!-- 로그인 유저로부터 정보를 받아오기 -->

									<label for="tfName" class="tf_comm"> 
									 <input type="text" id="creName"	class="tf_cont" value=""  name="creName">
									</label>
								</p>
							</li>
							<li class="box_info">
		...
		<div class="btn_area">
				 ...
				 <input type="submit" class="btn_next" title="다음단계" value="다음단계" id="btn2">
					</div>
		</form>
