	...
	<br>
		...
		<!-- 신청서 -->
			...
			<div class="sheet_info">
				<div class="form_area">
					<form action="startUpprojectInsert.do" name="addForm" method="post" enctype="multipart/form-data" id="frm" onsubmit="return fn_validateCheck()">
						...
						<fieldset class="fld_comm">
							...
							<ul>
								...
								<li class="box_info">
									<p class="tit_name">
										창업 프로젝트 제목<span class="txt_warning">*</span>
									</p>
								...
								<li class="box_info">
									<p class="tit_agreement">
										창업 프로젝트 소개<span class="txt_warning">*</span> 
									<div id="contentArea">
