...
.list_cate .on a {
     border: 3px solid #05a7e2 !important;
			...
			<article id="mContent" class="project_list">
				...
				<div class="box_category">
					...
					<ul id="category_list" class="list_cate" role="tablist">
						<c:url var="cate0" value="projectList2.do">
						...
						<c:url var="cate1" value="projectList2.do">
						...
						<c:url var="cate2" value="projectList2.do">
						...
						<c:url var="cate3" value="projectList2.do">
						...
						<c:url var="cate4" value="projectList2.do">
						...
						<c:url var="cate5" value="projectList2.do">
						...
						<c:url var="cate6" value="projectList2.do">
						...
						<c:url var="cate7" value="projectList2.do">
						...
						<c:url var="cate8" value="projectList2.do">
						...
						<c:url var="cate9" value="projectList2.do">
				...
				<div class="wrap_project">
					...
					<c:choose>
						...
						<div class="dropdown-menu dropdown-menu-right" aria-labelledby="sorting_btn">
							<c:url var="latest" value="projectList2.do">
								<c:param name="cate" value="${ currentCate }"/>
								<c:param name="arrange" value="1"/>
							</c:url>
							<c:url var="highest" value="projectList2.do">
								<c:param name="cate" value="${ currentCate }"/>
								<c:param name="arrange" value="2"/>
							</c:url>
							<c:url var="impendence" value="projectList2.do">
								<c:param name="cate" value="${ currentCate }"/>
				...
				<div class="paging">
					<nav aria-label="Page navigation example" class="page-nav">
						<ul class="pagination">
							...
							<c:if test="${ pi.currentPage > 1 }">
								<c:url var="before" value="projectList2.do">
							...
							<c:forEach var="p" begin="${ pi.startPage }" end="${ pi.endPage }">
								<c:if test="${ p eq pi.currentPage }">
									<li class="page-item" aria-current="page">
										<a class="page-link" style="background-color:#05a7e2; color:#ffffff;">${ p }</a>
									</li>
								</c:if>
								<c:if test="${ p ne pi.currentPage }">
									<c:url var="pagination" value="projectList2.do">
							...
							<c:if test="${ pi.currentPage < pi.maxPage }">
								<c:url var="after" value="projectList2.do">
									<c:param name="page" value="${ pi.currentPage + 1 }"/>
									<c:param name="cate" value="${ currentCate }"/>
									<c:param name="arrange" value="${ currentArrange }"/>
								</c:url> 
